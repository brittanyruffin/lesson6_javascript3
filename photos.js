...
function createEventListeners() {
    ...
    //declaire variable for document element with id of leftarrow, which is in the html document var leftarrow = document.getElementById("leftarrow");
